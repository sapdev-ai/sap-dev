...
# explicit /app/con[0]/ses[N] via `--session` when targeting a specific
# session in a parallel context. AttachSapSession honours the empty case
# with the legacy first-session-of-first-connection default.

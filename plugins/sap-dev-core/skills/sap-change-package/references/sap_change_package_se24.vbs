...
'   Change the package of a class / interface via SE24 > Goto > Object Directory.
'
...
oSess.findById("wnd[0]/usr/ctxtSEOCLASS-CLSNAME").Text = sName
WScript.Sleep 200
If Err.Number <> 0 Then
    WScript.Echo "ERROR: Class name field not found (ctxtSEOCLASS-CLSNAME)."
    WScript.Quit 1
End If
Err.Clear
On Error GoTo 0

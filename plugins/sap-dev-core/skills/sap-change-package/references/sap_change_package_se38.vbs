...
Sub ChangePackageFlow
    ...
    ' --- 9. SUCCESS gate: sbar not E/A AND no popup left on screen -------------
    ...
    ' The move is sbar-confirmed only inside the GUI. The skill re-queries TADIR
    ' (SKILL.md Step 7) for the authoritative confirmation.

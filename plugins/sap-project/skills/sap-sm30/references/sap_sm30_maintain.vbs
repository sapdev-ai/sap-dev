' sap_sm30_maintain.vbs  --  NEEDS_RECORDING placeholder for a release-sensitive SAP GUI write leg.
'
...
WScript.Echo "SM30: NEEDS_RECORDING -- capture this GUI flow via /sap-gui-probe --record (see SKILL.md)"
WScript.Quit 3

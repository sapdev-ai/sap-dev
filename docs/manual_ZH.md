...
> 本手册所基于的工具集版本：**v0.6.7**（2026-06-26）。

> 📖 这是英文手册 [`manual.md`](manual.md) 的简体中文译本。**以英文版为准**，本译本同步至 v0.6.7（2026-06-26）。如有出入，以英文版为准。
...
*本手册覆盖 sap-dev v0.6.7。技能在不断演进 —— 拿不准时，每个技能的 SKILL.md 才是真相
